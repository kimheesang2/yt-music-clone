...
// 분위기 및 장르
export const dummyGenreList = ["출퇴근 & 등하교","힘이 필요할 때","행복한 기분","K-Pop","운동할 때","Pop","Party","가족","Hip-Hop","한국힙합","R&B및소울","Romance","편안한분위기","슬픔","댄스&일렉트로닉","잠잘때","집중할때","OST&뮤지컬","인디및얼터너티브","포크/어쿠스틱","프라이드","PopLatino","Rock","2010s","블랙라이브즈매터","2000s","Seasonal","재즈","Christmas","J팝","아프리카","Reggae&Caribbean","영국랩","컨트리&아메리카나","클래식","1980s","브라질을사로잡은음악","크리스천및가스펠","일본랩","메탈","1990s","1970s","스페인록","1960년대","ArgentinianRock","라틴","블루스","스페인힙합","1950년대","프랑스힙합","MúsicaMexicana","아랍음악","독일힙합","발리우드&인도","Tropical","이라크음악","Cumbia","아랍힙합","인도/파키스탄힙합","튀르키예 힙합","브라질 힙합"]