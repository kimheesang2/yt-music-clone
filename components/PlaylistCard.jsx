...
import IconButton from './elments/IconButton';
    ...
    <article className='h-[240px] cursor-pointer group'>
      <section onClick={onClickCard} className='relative h-[136px]'>
        ...
        <div className=' hidden relative group-hover:block bg-gradient-to-b from-[rgba(0,0,0,0.7)] top-0 w-full h-[136px]'>
          ...
          <div className='absolute bottom-4 right-4 flex justify-center items-center transform-gpu transition-transform hover:scale-110 bg-[rgba(0,0,0,0.7)] w-[45px] h-[45px] rounded-full hover:bg-[rgba(0,0,0,0.7)] pl-[1px]'>
